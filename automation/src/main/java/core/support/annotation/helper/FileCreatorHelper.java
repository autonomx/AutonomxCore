...
public class FileCreatorHelper {
	...
	public static JavaFileObject createModuleFile() throws IOException {
		moduleFileObject = MainGenerator.PROCESS_ENV.getFiler()
				.createSourceFile(PackageHelper.MODULE_MANAGER_PATH + "." + PackageHelper.MODULE_CLASS);
	...
	public static JavaFileObject createFile(String path) throws IOException {
		moduleManagerFileObject = MainGenerator.PROCESS_ENV.getFiler()
				.createSourceFile(PackageHelper.MODULE_MANAGER_PATH + "." + PackageHelper.MODULE_MANAGER_CLASS);
	...
	public static JavaFileObject createCsvModuleObjectFile(String module) throws IOException {
		CSVDATA_CSV_File_Object = MainGenerator.PROCESS_ENV.getFiler()
				.createSourceFile(PackageHelper.DATA_PATH + "." + module + "." + module);
		return CSVDATA_CSV_File_Object;
	}
	...
	public static JavaFileObject createCSVDataObjectFile(File file) throws IOException {
		CSVDATA_DATA_File_Object = MainGenerator.PROCESS_ENV.getFiler()
				.createSourceFile(PackageHelper.DATA_PATH + "." + StringUtils.capitalize(DATA_ROOT));
